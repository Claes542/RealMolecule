...
\begin{itemize}
\item \textbf{The free electron's own moment.} A free electron carries $\sim\mu_B$; in this framework
that must arise from a genuine phase winding (a self-consistent internal circulation, in the spirit of
the Zitterbewegung reading of spin). The present real-valued solver, which finds real ground states by
imaginary-time relaxation, cannot produce such a state. The test is whether the free electron's
self-consistent RealQM state develops the winding that gives $\mu_B$, while the caged electron remains
$m=0$.
