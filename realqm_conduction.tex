...
fitted parameters appears to have been carried out: the textbook $N$-electron state lives on a
$3N$-dimensional configuration space, so every practical route reduces the dimension and repairs the
reduction with modelled quantities --- a relaxation time, a transfer integral, an effective mass.
