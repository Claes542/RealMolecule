...
\title{Conduction vs Insulation by RealQM\\ \large and the Missing Degeneracy Pressure}
...
\textbf{That last step identifies the obstruction.} The framework's free interface admits a flat
density at no cost, so its degeneracy-pressure coefficient is $C=0$ exactly --- the defect of
\S\ref{sec:coefficient} --- and it is that same missing stiffness which leaves the carriers soft
enough to lock to the lattice. One deficiency, two symptoms: a wrong equation of state and an
...
missing term. One deficiency produces both symptoms: no degeneracy pressure, hence a wrong
compressibility, hence carriers soft enough to lock to the lattice. And \S\ref{sec:coefficient} also
...
\S\ref{sec:coefficient} already identified for the equation of state: $C=0$, no degeneracy pressure.
