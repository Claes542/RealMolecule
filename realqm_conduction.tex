...
One defect in the discretisation blocks more than any single measurement. Positions live on the
...
be measured by releasing the kernels and reading a period off a trajectory, which would retire the
...
why several quantities named in \S9 cannot presently be measured at all. Neither is a fitted
