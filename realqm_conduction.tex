...
\end{equation}
subject to $\int_{\Omega_i}\psi_i^2=1$, and written in atomic units: lengths in Bohr radii
$a_0=0.529$~\AA, energies in hartree, $1$~Ha${}=27.211$~eV. The ground state of the system is the
configuration
