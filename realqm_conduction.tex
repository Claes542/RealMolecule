...
field --- and its own field is a different function for every $i$. A multigrid solve costs a time
proportional to the number of mesh points, so a relaxation step costs $N$ times the mesh: linear in
$N$ at a fixed grid. The single wave function of textbook quantum mechanics, by contrast, lives on a
