...
The catch: the compact electron is then \emph{relativistic}, requiring a Dirac-like extension of
RealQM (the engine is non-relativistic, which is why it yields binding \emph{ratios} but not the
absolute MeV).
