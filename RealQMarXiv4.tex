...
The RealQM model can be extended to describe interaction matter--radiation following a principle developed in~\cite{Johnson2010BB}, which can be expressed as a classical wave equation with two dissipative channels:
\begin{equation}
