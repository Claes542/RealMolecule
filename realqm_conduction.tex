...
alone. The geometry is specified rather than found: the supports are held while
the wave functions relax, so what is computed is a constrained minimum, and the arrangements held
