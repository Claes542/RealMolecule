...
The task posed to it here is conduction: what does it cost to advance the electron pattern of a
...
supports in three-dimensional space, with the physics carried by one energy functional built from
Coulomb interaction and kinetic energy, and the ground state the configuration minimising it over
the supports as well as over the wave functions. What enters that functional is those two terms and
a specification of the nuclei. Nothing in it has been adjusted to reproduce a measured quantity.

The task posed to it here is conduction: what does it cost to advance the electron pattern of a
solid by one lattice site, which is the activation energy for charge transport. The answer is
obtained from the two terms alone, and such a computation does not appear to have been carried out
