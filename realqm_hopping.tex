...
This article sets out what RealQM, as a new alternative to textbook quantum mechanics, offers for
conduction in solids. The question it is asked is the elementary one: \textbf{can RealQM explain the
difference between a conductor and an insulator}, given only the charges present and their Coulomb
interaction? The answer turns out to depend on what the carrier is asked to be, and it is reached by
measuring two models.
