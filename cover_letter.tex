...
\textit{Enclosures}: manuscript PDF (\texttt{RealQMarXiv4.pdf}), LaTeX source (\texttt{RealQMarXiv4.tex}), figure (\texttt{figures/validation\_summary.pdf}), arXiv preprint identifier (when available).
