...
falsifiable. This second version is formulated \emph{without relativity}: all energies are taken as
...
The Sun shines by fusing \emph{hydrogen} into helium, releasing $26.73$~MeV per helium nucleus. What is
consumed are hydrogen atoms --- protons \emph{and} electrons --- and the two accounts of the burning
differ already in how they write the ingredients. The standard account keeps only the protons, treating
...
the small doorway, and $d+d\to{}^4\mathrm{He}$ is the powerhouse. (In the Sun the abundance-weighted
