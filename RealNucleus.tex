...
\begin{figure}[t]
\centering
\includegraphics[width=0.72\textwidth]{confinement2e4p.png}
\caption{Dual confinement in the alpha ($\mathrm{2e}+\mathrm{4p}$), shown through the two
Coulomb potentials. The potential generated by the electrons (red) is a deep central well that
attracts the protons inward; the potential generated by the protons (green) attracts the
electrons outward toward the surrounding protons, depleting the core. Each species is held in
place by the other's potential --- by Coulomb attraction alone, with no external or strong-force
confinement.}
...
further fitting. The alpha particle, $\mathrm{4p}+\mathrm{2e}$ as a $-2$ electron core inside a
tetrahedral proton shell, comes out at $E=-27.8$, i.e. \textbf{29.1~MeV against the experimental
28.3 (103\%)}, and the alpha/deuteron ratio at $13.1$ versus the experimental $12.7$. That a
single Coulomb scale carries both the simplest and the most tightly bound light nucleus, with no
adjustable parameter, is the central quantitative result.
