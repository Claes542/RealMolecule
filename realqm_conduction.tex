...
energies across the periodic table are reproduced without fitting \cite{realatoms,realqm}. For
transport there is as yet nothing, and the activation energy is the quantity that would supply it,
being exactly what an Arrhenius plot of a real activated conductor measures. This article computes
that quantity and does not yet compare it with one.
