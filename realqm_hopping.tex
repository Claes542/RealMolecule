...
explanation of the difference between conductors and insulators --- given only the charges present
and their Coulomb interaction, with nothing further supplied. The answer turns out to depend on what
the carrier is asked to be, and it is reached by measuring two models.
