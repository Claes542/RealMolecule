...
\midrule
Covalent bond          & H$_2$ binding energy          & $-92$       & $-109$ kcal/mol & 16\%                    & \ref{sec:h2bond}    \\
\midrule
...
\midrule
Materials              & NaCl Lindemann threshold       & T$_\mathrm{sim} \approx 1500$--$2000$~K & $T_m = 1074$~K & $\sim$1.4--1.9$\times$ scale offset & \ref{sec:nacl}     \\
\bottomrule
\end{tabular}
