...
supplies the repair --- a Robin interface at $\beta a=1.146$ restores $C=C_{\rm TF}$ exactly --- so
the prediction is sharp: a RealQM with the interface condition corrected should not insulate here.
