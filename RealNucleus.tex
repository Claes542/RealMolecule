...
binding ever since. To our knowledge \emph{no} mainstream model binds the nucleus by Coulomb
forces alone; the strong (today, residual QCD) force is universal.
...
over-bind, and the experiment-matching spread is identified by hand. Some configurations relax
