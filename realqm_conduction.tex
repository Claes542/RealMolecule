...
\end{equation}
where $x,y\in\mathbb{R}^3$ are points of ordinary three-dimensional space, $i$ and $j$ index the
electrons, $s$ indexes the nuclei, and $Z_s$ and $x_s$ are the charge and position of nucleus $s$;
the supports $\Omega_i\subset\mathbb{R}^3$ are disjoint and $\int_{\Omega_i}\psi_i^2=1$. Atomic
