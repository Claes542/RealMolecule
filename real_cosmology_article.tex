...
$c=\sqrt{T/\mu}$ is its \emph{wave speed} (a property of the medium, not an Einstein postulate), and a
charge's mass is its \emph{field self-energy} in the medium (electromagnetic mass, Lorentz--Poincar\'e).
From the wave momentum $P=mc$ with $E=Pc$ one obtains $E=mc^2$ (\cite{mmr}, ch.~16) --- mass--energy
equivalence as a medium-wave result, with no Lorentz-transformation kinematics. The same tension
supplies the \emph{Poincar\'e stresses} that hold each charge cloud together against its own Coulomb
self-repulsion (the Bernoulli free boundary of RealQM), curing the classical instability of
electromagnetic mass. The substrate thus does triple duty: it carries light at $c$, stabilises the
charge clouds, and its curvature is mass and charge.
...
${\sim}10^5$ separation is the central open problem (Section~\ref{sec:open}).
