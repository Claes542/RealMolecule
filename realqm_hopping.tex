...
owed that before the argument that surrounds it. The first is an \textbf{atomic chain}: model atoms
...
which the pattern would run. The second is an \textbf{ion--electron cable}: ion cores along an axis
