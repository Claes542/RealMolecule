...
\begin{abstract}
\noindent RealQM, an alternative to textbook quantum mechanics, represents an $N$-electron system by $N$
real-valued wave functions on non-overlapping supports in three-dimensional space, meeting at free
interfaces. One energy functional carries the physics --- Coulomb potential energy without
self-repulsion, plus kinetic energy --- with nothing fitted, at a cost scaling as $N$ times the
number of mesh points.

It has been applied to solids, to molecular binding and solvation, and to nuclear binding --- always
to \emph{bound} matter, where an attractor holds the charge. The task here is conduction: what it
costs to advance the electron pattern of a solid by one lattice site, the activation energy for
charge transport. No such computation without fitted parameters appears to have been carried out,
because the textbook $N$-electron state lives on a $3N$-dimensional configuration space, so every
practical route reduces the dimension and repairs the reduction with modelled quantities --- a
relaxation time, a transfer integral, an effective mass.

The quantity is small against the total energy and is reached by differencing two configurations of
one system, so that the large errors cancel. Four cases are computed. A \textbf{chain of sixteen
hydrogen atoms} gives $394$~meV per electron, its minimum off registry near a quarter spacing, so
advancing one site is a two-step passage. A \textbf{cable of sixteen lithium ions}, carriers
standing off closed cores, gives $246$~meV; stiffening those carriers takes it to $20$~meV, below
room-temperature $kT$. A \textbf{cubic lattice of seventy-two hydrogen atoms} yields no barrier:
windowed and scanned, its landscape descends away from registry, which is not its minimum either.

From the landscapes alone follow threshold fields of $5.2$, $3.2$ and $0.26$~GV\,m$^{-1}$. Closing
the prefactor with a rate theory puts the first two at $0.1$ and $11$~S\,m$^{-1}$, bracketing
intrinsic germanium, with attempt frequencies landing at lattice values unasked. Those
conductivities are lower bounds and the frequencies overestimates; the barriers are what is
computed.
\end{abstract}
...
bound matter: the binding of H$_2$ comes out $4.20$~eV against $4.75$ measured, and atomic total
energies across the first three periods are reproduced to about $1.7$ per cent without fitting
\cite{realatoms,realqm}.
...
\midrule
chain of H atoms & $394$~meV & $1.8\times10^{13}$ & $1.2\times10^{-1}$ & intrinsic Ge, $2$\\
cable of Li ions & $246$~meV & $5.5\times10^{12}$ & $11$ & intrinsic Ge, $2$\\
...
live: as an energy $h\nu$, $23$~meV for the cable and $76$~meV for the hydrogen chain, the latter high because a proton
...
\toprule
case & $V_0$ (meV) & $M$ & $K$ (eV\,\AA$^{-2}$) & $\nu$ (Hz) & $\sigma_0$ (S/m) & $e^{-V_0/kT}$ & $\sigma$ (S/m)\\
\midrule
chain of H & $394$ & $1$~u & $1.37$ & $1.8\times10^{13}$ & $4.8\times10^{5}$ & $2.5\times10^{-7}$ & $1.2\times10^{-1}$\\
cable of Li & $246$ & $7$~u & $0.86$ & $5.5\times10^{12}$ & $1.4\times10^{5}$ & $7.5\times10^{-5}$ & $11$\\
\quad at $c=0.9$ & $20$ & $7$~u & $0.070$ & $1.6\times10^{12}$ & $4.1\times10^{4}$ & $0.46$ & $(1.9\times10^{4})$\\
\bottomrule
\end{tabular}
\end{center}
\noindent The last row is bracketed: at $20$~meV against $kT=25.9$ the barrier is $0.77\,kT$ and
the rate law does not apply, as \S6 states; the entry is given only to show what it would return.
Taking $M=m_e$ instead of an ionic mass raises $\nu$ to $6.2\times10^{14}$~Hz and $\sigma$
to $1.2\times10^{3}$~S\,m$^{-1}$ on the middle row; that frequency is two orders above any lattice
